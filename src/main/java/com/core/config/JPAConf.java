...
//close
    @Bean(destroyMethod = "") protected DataSource dataSource() {
        HikariConfig dataSourceConfig = new HikariConfig();
        dataSourceConfig.setDriverClassName("com.mysql.cj.jdbc.Driver");
        dataSourceConfig.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/shopnuochoa?useUnicode=yes&characterEncoding=UTF-8&enabledTLSProtocols=TLSv1.2");
        dataSourceConfig.setUsername("root");
        dataSourceConfig.setPassword("Hieu1@");
    ...
    @Bean protected LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.core"); // root
