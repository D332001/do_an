                            ...
                            <div class="my-4">
                                ...
                                <form:form method="post" id="formname" action="/admin/save-product" modelAttribute="product" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form:input type="text" class="form-control" path="size" id="author"/><span style="color:red;" id="numloc7"></span><br/>
                                    </div>
                                    <div class="form-group">
                                        <label>Tác giả</label>
                                        <form:input type="text" class="form-control" path="style" id="publish"/><span style="color:red;" id="numloc8"></span><br/>
                                    </div>
                                    <div class="form-group">
